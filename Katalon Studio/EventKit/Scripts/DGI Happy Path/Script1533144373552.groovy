...
WebUI.setText(findTestObject('Object Repository/Page_EventKit/input_exportName'), 'DGI Happy Path')

WebUI.setText(findTestObject('Object Repository/Page_EventKit/textarea_DGI Happy Path'), 'DGI Happy Path')

WebUI.setText(findTestObject('Object Repository/Page_EventKit/input_projectName'), 'DGI Happy Path')

WebUI.click(findTestObject('Object Repository/Page_EventKit/input_DigitalGlobe Imagery (Fo'))

WebUI.click(findTestObject('Object Repository/Page_EventKit/path'))

WebUI.click(findTestObject('Object Repository/Page_EventKit/div_DGI Happy Path'))

WebUI.click(findTestObject('Object Repository/Page_EventKit/div_DGI Happy Path'))

WebUI.click(findTestObject('Object Repository/Page_EventKit/div_DGI Happy Path'))

WebUI.click(findTestObject('Object Repository/Page_EventKit/p_DigitalGlobe Imagery (Founda'))
