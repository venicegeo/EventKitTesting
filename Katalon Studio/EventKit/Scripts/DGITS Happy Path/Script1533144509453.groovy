...
WebUI.setText(findTestObject('Object Repository/Page_EventKit/input_exportName'), 'DGITS Happy Path')

WebUI.setText(findTestObject('Object Repository/Page_EventKit/textarea_DGI Happy Path'), 'DGITS Happy Path')

WebUI.setText(findTestObject('Object Repository/Page_EventKit/input_projectName'), 'DGITS Happy Path')
