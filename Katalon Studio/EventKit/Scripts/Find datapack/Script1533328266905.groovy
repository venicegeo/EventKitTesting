...
WebUI.setText(findTestObject('Object Repository/Page_EventKit/input_exportName'), 'Find Me')

WebUI.setText(findTestObject('Object Repository/Page_EventKit/textarea_DGI Happy Path'), 'Find Me')

WebUI.setText(findTestObject('Object Repository/Page_EventKit/input_projectName'), 'Find Me')

WebUI.click(findTestObject('Page_EventKit/DGITS_radio'))
...
WebUI.click(findTestObject('Page_EventKit/DataPack library'))

WebUI.verifyElementPresent(findTestObject('Page_EventKit/Find Me Datapack'), 0)

WebUI.click(findTestObject('Page_EventKit/Find Me Datapack'))
