...
WebUI.setText(findTestObject('Object Repository/Page_EventKit/input_exportName'), 'NOME Happy Path')

WebUI.setText(findTestObject('Object Repository/Page_EventKit/textarea_DGI Happy Path'), 'NOME Happy Path')

WebUI.setText(findTestObject('Object Repository/Page_EventKit/input_projectName'), 'NOME Happy Path')

WebUI.click(findTestObject('Page_EventKit/NOME_radio'))
